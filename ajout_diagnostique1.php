...
<html><head>
	...
	<meta name="description" content="créer un nouveau diagnostique">
...
?>
		...
		<br><br>
	<h2><span style="border: 3px #002B5D ridge; paddling 6px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Saisie d'un nouveau diagnostique&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></h2>
<br>
	
	<form action="ajout_diagnostique.php" method="post">
		...
		<p>Examen pratique : <input name="exam_pratique" type="text"></p>
		<p>Commentaires : <input name="commentaire" type="text"></p>
		<p>Date du diagnostique : <input name="date" type="date"></p>
